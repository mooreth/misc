#Here
input_file = open('minimized tile.pdb', 'r') 
...
for line_sam in igot:
    if line_sam.find("HETATM ") > -1:        
        ...
        pdb_line = record_name_pad*" " + tag +index_pad*" " +index + " " + element + character*" " + residue_name* " " + chainID_pad*" " + chainID + residue_seqeunce_num_pad*" " + residue_sequence_num + iCode*" "+ x_len_pad*" "+ xcor + y_len_pad*" "+ ycor + z_len_pad*" "+ zcor+"  1.00  0.00           "+ element       +"\n"
